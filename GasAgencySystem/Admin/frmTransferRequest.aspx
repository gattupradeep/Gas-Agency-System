<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="~/Admin/frmTransferRequest.aspx.cs" Inherits="Admin_frmTransferRequest" Title="Untitled Page" %>
...
<table>
<tr><td>
    <asp:GridView ID="gvTransferRequests" runat="server" 
        AutoGenerateColumns="False" CellPadding="4" 
        ForeColor="#333333" GridLines="None" 
        onrowediting="gvTransferRequests_RowEditing" Width="611px">
    ...
    <asp:BoundField DataField="SNO" HeaderText="RequestNo"   /> 
        ...
        <asp:BoundField DataField="Status" HeaderText="Status" 
            ...
            <asp:CommandField EditText="Accept" ShowEditButton="true"    />  
    </Columns>
