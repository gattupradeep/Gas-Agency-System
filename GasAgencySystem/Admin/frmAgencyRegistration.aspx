<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmAgencyRegistration.aspx.cs" Inherits="Admin_frmAgencyRegistration" Title="Untitled Page" %>
                ...
                <ContentTemplate>
                    ...
                    <table style="border: thin solid #5D7B9D; background-color: Window; width: 500px; ">
                        ...
                        <td colspan="6" align="center" style="background-color:#C1312F" >
                            <b style="color:White">&nbsp;Agency Registration Form </b>
                        </td>
                        </tr>
                        <tr>
                        <td colspan="6"></td>
                       ...
                       <asp:RequiredFieldValidator ID="rfvRole" runat="server" ErrorMessage="*" ControlToValidate="ddlRole" ></asp:RequiredFieldValidator>
                        ...
                        <td>&nbsp;</td>
                        <td>District</td><td align="left"><asp:DropDownList ID="ddlDistrict" runat="server" 
                                AutoPostBack="True" onselectedindexchanged="ddlDistrict_SelectedIndexChanged"></asp:DropDownList> </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="rfvagency" runat="server" 
                                    ControlToValidate="txtAgencyName" ErrorMessage="*"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                City</td>
                            <td align="left">
